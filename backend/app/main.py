...
from .global_chat import build_global_chat_router
...
def create_app(
    ...
    doc_fetcher: Optional[DocFetcher] = None,
) -> FastAPI:
    ...
    app.include_router(build_global_chat_router(data_dir, require_session, resolved_llm_client))
